	...
	int       nCmdShow)
{
	...
	// 1.0, 1.1, 2.0, 3.0, 3.5, 4, 4.5, 4.5.1, 4.5.2, 4.6, 4.6.1, 4.6.2, 4.7 or 4.7.1 are installed
	...
	// The .NET Framework 4.5, 4.5.1, 4.5.2, 4.6, 4.6.1, 4.6.2, 4.7 and 4.7.1 are in-place replacements for the .NET Framework 4.
